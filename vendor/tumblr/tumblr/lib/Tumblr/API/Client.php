...
class Client
{
     ...
     */
    public function __construct($consumerKey, $consumerSecret = null, $token = null, $secret = null, $proxy = '')
    {
        $this->requestHandler = new RequestHandler( $proxy );
    ...
    private function parseResponse($response)
    {
	    ...
	    $response->body = preg_replace('/:\s*(-?\d{'.$max_int_length.',})/', ': "$1"', $response->body);
