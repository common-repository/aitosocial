 ...
 */
namespace FSP\phpseclib3\File;

use FSP\ParagonIE\ConstantTime\Base64;
...
use FSP\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use FSP\phpseclib3\Exception\UnsupportedAlgorithmException;
use FSP\phpseclib3\File\ASN1\Element;
...
class X509
{
    ...
    public function sign($issuer, $subject)
    {
        ...
        if (isset($subject->domains) && \count($subject->domains)) {
            $altName = \array_map(['\\FSP\\phpseclib3\\File\\X509', 'dnsName'], $subject->domains);
        }
