 ...
 */
namespace FSP\phpseclib3\Crypt;

use FSP\phpseclib3\Crypt\Common\AsymmetricKey;
use FSP\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use FSP\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use FSP\phpseclib3\Crypt\EC\Curves\Curve25519;
use FSP\phpseclib3\Crypt\EC\Curves\Ed25519;
use FSP\phpseclib3\Crypt\EC\Curves\Ed448;
use FSP\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use FSP\phpseclib3\Crypt\EC\Parameters;
use FSP\phpseclib3\Crypt\EC\PrivateKey;
use FSP\phpseclib3\Crypt\EC\PublicKey;
use FSP\phpseclib3\Exception\UnsupportedAlgorithmException;
use FSP\phpseclib3\Exception\UnsupportedCurveException;
use FSP\phpseclib3\Exception\UnsupportedOperationException;
use FSP\phpseclib3\File\ASN1;
use FSP\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\\FSP\\phpseclib3\\Crypt\\EC\\Curves\\' . $curveName;
