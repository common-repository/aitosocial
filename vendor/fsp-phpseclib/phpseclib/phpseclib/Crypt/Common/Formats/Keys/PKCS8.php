...
abstract class PKCS8 extends PKCS
{
    ...
    {
        self::initialize_static_variables();
        $key = ['publicKeyAlgorithm' => ['algorithm' => \is_string(static::OID_NAME) ? static::OID_NAME : $oid, 'parameters' => $params], 'publicKey' => "\x00" . $key];
