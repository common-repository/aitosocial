...
<div class="fsp-metabox fsp-is-mini">
	...
	<div class="fsp-card-body fsp-metabox-accounts">
		...
		if ( ! $feedsCount )
		{
			echo fsp__( 'The post hasn\'t been shared on any account! <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue11\' target=\'_blank\'>Why?</a>', [], FALSE );
		} ?>
	</div>
