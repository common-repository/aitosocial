...
<div class="fsp-modal-header">
    <div class="fsp-modal-title">
        <div class="fsp-modal-title-icon" style="background-image: unset; margin-right: 8px">
            <i class="planly-icon planly-icon-18"></i>
        </div>
        <div class="fsp-modal-title-text">
			<?php echo fsp__( 'Add a Planly Account' ); ?>
        </div>
    </div>
    ...
    <div class="fsp-modal-step">
        <div class="fsp-form-group">
            <label class="fsp-is-jb">
				<?php echo fsp__( 'Access token' ); ?>
                <a href="https://project.puredevs.com/documentation/how-to-auto-publish-and-schedule-wordpress-posts-to-tiktok" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
                    <i class="far fa-question-circle"></i>
                </a>
            </label>
            <div class="fsp-form-input-has-icon">
                <i class="fas fa-robot"></i>
                <input id="fspAccessToken" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Access token' ); ?>">
            </div>
        </div>
    </div>
...
<script>
    jQuery( document ).ready( function () {
        FSPoster.load_script( '<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-planly.js' ); ?>' );
    } );
</script>
