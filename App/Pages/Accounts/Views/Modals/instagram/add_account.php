...
<div class="fsp-modal-header">
	<div class="fsp-modal-title">
		...
		<div class="fsp-modal-title-text">
			<?php echo fsp__( 'Add an Instagram account' ); ?>
		</div>
	</div>
...
<div class="fsp-modal-body">
	<p class="fsp-modal-p fsp-is-jb">
		<?php echo fsp__( 'Select an authorization method to add a new Instagram account' ); ?>
		<a href="https://project.puredevs.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-instagram" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
			<i class="far fa-question-circle"></i>
		</a>
	</p>
	<!--<div class="fsp-modal-options fsp-modal-options-instagram">
		...
		<div class="fsp-modal-option" data-step="2">
			...
			<?php echo fsp__( 'Login & password' ); ?>
		</div>
		<div class="fsp-modal-option" data-step="3">
			<div class="fsp-modal-option-image">
				<img src="<?php echo Pages::asset( 'Accounts', 'img/android.svg' ); ?>">
			</div>
	...
	<div id="fspModalStep_1" class="fsp-modal-step">
		<div class="fsp-form-checkbox-group fsp-checkbox-option fsp-is-selected" data-step="1">
            <input id="fspUseCookieMethod" type="checkbox" class="fsp-form-checkbox">
            <label for="fspUseCookieMethod">
                <?php echo fsp__( 'Cookie method' ); ?>
            </label>
        </div>
		<div id="fspCookieMethodContainer" class="fsp-form-group fsp-hide">
			<div class="fsp-form-group">
				<label><?php echo fsp__( 'Cookie' ); ?> csrftoken</label>
				<div class="fsp-form-input-has-icon">
					<i class="far fa-copy"></i>
					<input id="fspCookie_csrf_token" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the cookie' ); ?> csrftoken">
				</div>
			</div>
			<div class="fsp-form-group">
				<label><?php echo fsp__( 'Cookie' ); ?> ds_user_id</label>
				<div class="fsp-form-input-has-icon">
					<i class="far fa-copy"></i>
					<input id="fspCookie_ds_user_id" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the cookie' ); ?> ds_user_id">
				</div>
			</div>
			<div class="fsp-form-group">
				<label><?php echo fsp__( 'Cookie' ); ?> sessionid</label>
				<div class="fsp-form-input-has-icon">
					<i class="far fa-copy"></i>
					<input id="fspCookie_sessionid" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the cookie' ); ?> sessionid">
				</div>
			</div>
		</div>
	</div>
	<div id="fspModalStep_2" class="fsp-modal-step">
		<div class="fsp-form-checkbox-group fsp-checkbox-option" data-step="2">
            <input id="fspUseLogPassMethod" type="checkbox" class="fsp-form-checkbox">
            <label for="fspUseLogPassMethod">
                <?php echo fsp__( 'Login & password' ); ?>
            </label>
        </div>
		<div id="fspLoginPasswordContainer" class="fsp-form-group fsp-hide">
			<div class="fsp-form-group">
	...
	<div id="fspModalStep_3" class="fsp-modal-step">
		<div class="fsp-form-checkbox-group fsp-checkbox-option" data-step="3">
        ...
        <div id="fspCustomAppContainer" class="fsp-form-group fsp-hide">
			...
			<select class="fsp-form-select" id="fspModalAppSelector">
				...
				{ ?>
					<option disabled><?php echo fsp__( 'There isn\'t an Instagram App!' ); ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
...
<script>
	jQuery( document ).ready( function () {
		FSPoster.load_script( '<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-instagram.js' ); ?>' );
	} );
</script>
