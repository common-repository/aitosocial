...
<div class="fsp-modal-header">
	<div class="fsp-modal-title">
		...
		<div class="fsp-modal-title-text">
			<?php echo fsp__( 'Add a Facebook account' ); ?>
		</div>
	</div>
...
<div class="fsp-modal-body">
	<p class="fsp-modal-p fsp-is-jb">
		...
		<a href="https://project.puredevs.com/documentation/how-to-schedule-and-auto-publish-to-facebook-from-wordpress" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
