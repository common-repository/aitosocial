...
<div class="fsp-modal-body">
	<div class="fsp-modal-step">
		...
		<div class="fsp-form-group">
			<label>
				<?php echo fsp__( 'Select a Facebook page to share your posts in Facebook groups on behalf of the page. Note that the page has to be <a href="https://project.puredevs.com/documentation/commonly-encountered-issues#issue4" target="_blank">linked to the group</a>; otherwise, the post will fail.', [], FALSE ); ?>
			</label>
