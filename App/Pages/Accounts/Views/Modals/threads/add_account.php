...
<div class="fsp-modal-body">
	<p class="fsp-modal-p fsp-is-jb">
		...
		<a href="https://project.puredevs.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-threads" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
