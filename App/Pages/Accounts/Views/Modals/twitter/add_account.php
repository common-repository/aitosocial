...
<div class="fsp-modal-header">
	<div class="fsp-modal-title">
		...
		<div class="fsp-modal-title-text">
			<?php echo fsp__( 'Add a Twitter account' ); ?>
		</div>
	</div>
...
<div class="fsp-modal-body">
	<p class="fsp-modal-p fsp-is-jb">
		<?php echo fsp__( 'Select an authorization method to add a new Twitter account' ); ?>
		<a href="https://project.puredevs.com/documentation/how-to-schedule-and-auto-publish-to-twitter-from-wordpress" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
	...
	<div id="fspModalStep_1" class="fsp-modal-step">
        ...
        <div id="fspCustomAppContainer" class="fsp-form-group fsp-hide">
            <label class="fsp-is-jb">
                ...
                <a href="https://project.puredevs.com/documentation/fs-poster-schedule-share-wordpress-posts-to-twitter-automatically" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
                    <i class="far fa-question-circle"></i>
                </a>
            </label>
            <select class="fsp-form-select" id="fspModalAppSelector">
                ...
                { ?>
                    <option disabled><?php echo fsp__( 'There isn\'t a Twitter App!' ); ?></option>
                <?php } ?>
            </select>
        </div>
	</div>
		...
		<div id="fspCookieMethodContainer" class="fsp-form-group fsp-hide">
			<div class="fsp-form-group">
				...
				<div class="fsp-form-input-has-icon">
					...
					<input id="twitterCookie" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'The cookie ' ); ?>auth_token">
				</div>
			</div>
		</div>
	</div>
