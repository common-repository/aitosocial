...
<div>
    <?php foreach ( $fsp_params[ 'accounts_list' ] as $account_info )
    {
        ...
        <div class="fsp-account">
            <div class="fsp-card fsp-account-item" data-id="<?php echo $account_info[ 'id' ]; ?>" data-type="account" data-driver="webhook" data-active="<?php echo isset( $account_info[ 'is_active' ] ) && ! empty( $account_info[ 'is_active' ] ) ? 1 : 0; ?>" data-hidden="<?php echo $account_info[ 'is_hidden' ]; ?>" data-failed="<?php echo $account_info[ 'status' ] === 'error' ? 1 : 0; ?>" data-cookie="0">
                <div class="fsp-account-inline">
                    ...
                    <div class="fsp-account-name">
                        ...
                        <span><?php echo $account_info['username'] ?></span>
                    </div>
                </div>
...
<script>
    FSPObject.editModalURL = 'edit_webhook_account';
    FSPObject.modalURL = 'add_webhook_account';
