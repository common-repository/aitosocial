...
class Action
{
	...
	public static function getNodeCustomPostingTypeSettings ( $nodeDriver )
	{
		...
		$nodesData = [
			'fb'                => [
				'title'   => $title,
				'text'    => fsp__( 'Link card view – shares the post link and the custom message. Facebook fetches the post as a link card view. <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ),
				'options' => $options
			],
			'twitter'           => [
				'title'   => $title,
				'text'    => fsp__( 'Link card view – shares the post link and the custom message. Twitter fetches the post as a link card view. <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ),
				'options' => $options
			],
			'planly'            => [
				'title'   => $title,
			...
			'linkedin'          => [
				'title'   => $title,
				'text'    => fsp__( 'Link card view – shares the post link and the custom message. Linkedin fetches the post as a link card view. <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ),
				'options' => $options
			],
            'threads'          => [
                'title'   => $title,
                'text'    => fsp__( 'Link card view – shares the post link and the custom message. Threads fetches the post as a link card view. <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message.', [], FALSE ),
                'options' => [
                    '1' => fsp__( 'Link card view' ),
