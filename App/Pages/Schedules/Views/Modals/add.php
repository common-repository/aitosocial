...
$p_ids = isset( $fsp_params[ 'info' ][ 'post_ids' ] ) ? $fsp_params[ 'info' ][ 'post_ids' ] : '';
$p_type = get_post_type($p_ids);
?>
	...
	<?php if ( ! ( isset( $fsp_params[ 'is_native' ] ) && $fsp_params[ 'is_native' ] === TRUE ) ) { ?>
			...
			<div class="fsp-form-group">
				...
				<div class="fsp-modal-row">
					<div class="fsp-modal-col">
						...
						<input type="date" autocomplete="off" class="fsp-form-input schedule_input_start_date" placeholder="<?php echo fsp__( 'Select date' ); ?>" value="<?php echo Date::datee( isset( $fsp_params[ 'info' ][ 'start_date' ] ) ? $fsp_params[ 'info' ][ 'start_date' ] : (isset( $fsp_params[ 'schedule_date' ] )  ? $fsp_params[ 'schedule_date' ] : 'now') ); ?>">
		...
		<div id="fspAddSchedule_2" class="fspAddSchedule-step <?php echo ( ! ( isset ( $fsp_params[ 'is_direct_share_tab' ] ) && $fsp_params[ 'is_direct_share_tab' ] === TRUE ) ) ? '' : 'fsp-hide'; ?>">
			...
			<div id="fspSchedulePostTypeFilterRow" class="fsp-form-group <?php echo isset( $fsp_params[ 'post_ids_count' ] ) && $fsp_params[ 'post_ids_count' ] > 0 ? 'fsp-hide' : ''; ?>">
				<label><?php echo fsp__( 'By post type' ); ?>&emsp;<i class="far fa-question-circle fsp-tooltip" data-title="<?php echo fsp__( 'You can select new post types in [ AItoSocial > Settings > Share post types ].' ); ?>"></i>
				</label>
