...
<div class="fsp-row">
	<div class="fsp-col-12 fsp-title">
		...
		<div class="fsp-title-button">
			...
			<a href="?page=ai-poster-schedules&view=calendar" class="fsp-button fsp-is-info">
			...
			<a href="https://project.puredevs.com/documentation/how-to-set-up-a-cron-job-on-wordpress-fs-poster-wp-plugin" target="_blank" class="fsp-button fsp-is-red fsp-tooltip" data-title="<?php echo fsp__( 'If you want the Schedule module to work on time, please configure Cron Job on your website. Click the button to learn more.' ); ?>">
