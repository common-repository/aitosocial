		...
		$( '.schedule_popup' ).on( 'click', '.schedule_save_btn', function () {
			...
			function save_schedule ()
			{
				FSPoster.ajax( 'schedule_save', {
					...
					//window.location.href = 'admin.php?page=ai-poster-schedules&view=list&search=' + searchedKeyword + '&schedule_page=' + page;
					window.location.href = 'admin.php?page=ai-poster-calendar';
				} );
			}
