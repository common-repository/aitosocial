...
<div class="fsp-settings-row fsp-is-collapser">
	<div class="fsp-settings-collapser">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can customize and share alt text for Pins, and the alt text length limit is 500 characters. Pinterest doesn\'t accept the Pin if the alt text exceeds the limit. That is why AItoSocial cuts the exceeding part of the text automatically.' ); ?></div>
	</div>
