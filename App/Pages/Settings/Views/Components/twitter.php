...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Link card view – shares the post link and the custom message. Twitter fetches the post as a link card view. <a href=\'https://aitosocials.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<select name="fs_twitter_posting_type" id="fspTwitterPostingType" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo fsp__( 'Link card view' ); ?></option>
			<option value="4" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '4' ? 'selected' : ''; ?>><?php echo fsp__( 'Only custom message' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Featured image' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'twitter_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo fsp__( 'All post images' ); ?></option>
		</select>
	</div>
</div>
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Twitter limits a Tweet length to a maximum of 280 characters.  By enabling the option, the first 280 characters of your custom message will be shared; otherwise, the tweet won\'t be shared because of the limit.' ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
    ...
    <div class="fsp-settings-col">
        <div class="fsp-toggle">
            <input type="checkbox" name="fs_post_allow_first_comment_twitter" class="fsp-toggle-checkbox" id="fspTwitterAllowComment" <?php echo Helper::getOption( 'post_allow_first_comment_twitter', '0' ) ? 'checked' : ''; ?>>
            <label class="fsp-toggle-label" for="fspTwitterAllowComment"></label>
        </div>
    </div>
</div>
<div id="fspTwitterFirstComment">
        ...
        <div class="fsp-settings-collapse">
            <div class="fsp-settings-col">
                ...
                <div class="fsp-custom-post" data-preview="fspCustomPostPreview1">
                    <textarea name="fs_post_first_comment_twitter" class="fsp-form-textarea"><?php echo esc_html( Helper::getOption( 'post_first_comment_twitter', "" ) ); ?></textarea>
		...
		<div class="fsp-settings-col">
			...
			<div class="fsp-settings-preview">
				...
				<div class="fsp-settings-preview-footer">
					<span class="fsp-settings-preview-footer-item">300 Retweets</span>
					<span class="fsp-settings-preview-footer-item">43 likes</span>
				</div>
			</div>
		</div>
	</div>
