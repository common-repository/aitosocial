...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Select where to share posts on Facebook. Note that Facebook API does not support sharing posts on the story so that accounts have to be added to the plugin via the <a target="_blank" href="https://aitosocials.com/documentation/add-a-facebook-account-using-the-cookie-method/">cookie method</a> to share posts on the account and page stories. Profile means Facebook account or page wall.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can upload and use a <a href="https://aitosocials.com/documentation/commonly-encountered-issues#issue12" target="_blank">custom font</a> for Facebook stories.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Link card view – shares the post link and the custom message. Facebook fetches the post as a link card view. <a href=\'https://aitosocials.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
