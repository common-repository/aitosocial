...
<div class="fsp-settings-row">
    <div class="fsp-settings-col">
        ...
        <div class="fsp-settings-label-subtext"><?php echo fsp__( 'Link card view – shares the post link and the custom message. Threads fetches the post as a link card view. <a href=\'https://aitosocials.com/documentation/commonly-encountered-issues#issue9\' target=\'_blank\'>Debug your website</a>;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message.', [], FALSE ); ?></div>
    </div>
    <div class="fsp-settings-col">
        <select name="fs_threads_posting_type" id="fspThreadsPostingType" class="fsp-form-select">
            <option value="1" <?php echo Helper::getOption( 'threads_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo fsp__( 'Link card view' ); ?></option>
            <option value="2" <?php echo Helper::getOption( 'threads_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Only custom message' ); ?></option>
            <option value="3" <?php echo Helper::getOption( 'threads_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo fsp__( 'Featured image' ); ?></option>
        </select>
    </div>
</div>
<div class="fsp-settings-row">
    <div class="fsp-settings-col">
        ...
        <div class="fsp-settings-label-subtext"><?php echo fsp__( 'Threads limits a post length to a maximum of 500 characters.  By enabling the option, the first 500 characters of your custom message will be shared; otherwise, the post won\'t be shared because of the limit.' ); ?></div>
    </div>
    <div class="fsp-settings-col">
        <div class="fsp-toggle">
            <input type="checkbox" name="fs_threads_auto_cut_message" class="fsp-toggle-checkbox" id="fs_threads_auto_cut_message"<?php echo Helper::getOption( 'threads_auto_cut_message', '1' ) ? ' checked' : ''; ?>>
            <label class="fsp-toggle-label" for="fs_threads_auto_cut_message"></label>
        </div>
    </div>
</div>
    ...
    <div class="fsp-settings-collapse">
        <div class="fsp-settings-col">
            ...
            <div class="fsp-custom-post" data-preview="fspCustomPostPreview">
                <textarea name="fs_post_text_message_threads" class="fsp-form-textarea"><?php echo esc_html( Helper::getOption( 'post_text_message_threads', "{title}" ) ); ?></textarea>
        ...
        <div class="fsp-settings-col">
            ...
            <div class="fsp-settings-preview">
                ...
                <div class="fsp-settings-preview-body">
                    <span id="fspCustomPostPreview" class="fsp-settings-preview-body-text"><?php echo esc_html( Helper::getOption( 'post_text_message_threads', "{title}" ) ); ?></span>
                    <div class="fsp-settings-preview-image"></div>
                </div>
                <div class="fsp-settings-preview-footer">
                    <span class="fsp-settings-preview-footer-item">9 replies</span>
                    <span class="fsp-settings-preview-footer-item">377 likes</span>
                </div>
            </div>
        </div>
    </div>
