...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Only Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<select name="fs_planly_posting_type" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'planly_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo fsp__( 'Featured image' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'planly_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'All Post Images' ); ?></option>
		</select>
	</div>
</div>
	...
	<div class="fsp-settings-collapse">
		<div class="fsp-settings-col">
			...
			<div class="fsp-custom-post" data-preview="fspCustomPostPreview2">
				<textarea name="fs_post_text_message_planly" class="fsp-form-textarea"><?php echo esc_html( Helper::getOption( 'post_text_message_planly', "{content_full}" ) ); ?></textarea>
