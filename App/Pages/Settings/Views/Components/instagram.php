...
<div class="fsp-settings-row">
    <div class="fsp-settings-col">
        ...
        <div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can upload and use a <a href="https://aitosocials.com/documentation/commonly-encountered-issues#issue12" target="_blank">custom font</a> for Instagram stories.', [], FALSE ); ?></div>
    </div>
    <div class="fsp-settings-col">
...
<div class="fsp-settings-row fsp-is-collapser">
    <div class="fsp-settings-collapser">
        ...
        <div class="fsp-settings-label-subtext"><?php echo fsp__( 'You can customize the text of the shared story as you like by using the available keywords. You can add the keywords to the custom message section easily by clicking on the keyword. You can also customize the appearance of the story using available options. You need to use the <a href="https://aitosocials.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-instagram" target="_blank">Login&Password method</a>  to share links to stories.', [], FALSE ); ?></div>
    </div>
    <div class="fsp-settings-collapse">
