...
class PinterestCookieApi
{
	...
	public function checkAccount ()
	{
		...
		if ( empty( $id ) || empty( $username ) )
		{
			$result[ 'error_msg' ] = fsp__( 'The account is disconnected from the AItoSocial plugin. Please update your account cookie to connect it to the plugin again. <a href=\'https://aitosocials.com/documentation/commonly-encountered-issues#issue8\' target=\'_blank\'>How to?</a>.', [], FALSE );
		}
		else
		{
			$result[ 'error' ] = FALSE;
