...
class Facebook extends SocialNetwork
{
	...
	public function cmd ( $cmd, $method, array $data = [] )
	{
		...
		{
			$data[ 'error' ][ 'message' ] = fsp__( 'Insufficient permission. <a href=\'https://project.puredevs.com/documentation/commonly-encountered-issues#issue5\' target=\'_blank\'>Learn more!</a>', [], FALSE );
		}
