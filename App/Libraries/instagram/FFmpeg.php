...
use FSP_Symfony\Component\Process\Process;
...
class FFmpeg
{
	...
	protected static function _autoDetectBinary ()
	{
		...
		throw new RuntimeException( fsp__( 'For sharing videos on Instagram, you have to install the FFmpeg library on your server and configure executables\' path. <a href=\'https://project.puredevs.com/documentation/how-to-install-ffmpeg\' target=\'_blank\'>How to?</a>', [], FALSE ) );
	}
